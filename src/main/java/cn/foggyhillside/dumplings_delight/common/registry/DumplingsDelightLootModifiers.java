...
import cn.foggyhillside.dumplings_delight.common.loot.modifier.AddTableLootModifier;
...
public class DumplingsDelightLootModifiers {
    ...
    public static final Supplier<Codec<? extends IGlobalLootModifier>>  ADD_CALAMARI = LOOT_MODIFIERS.register("add_table", AddTableLootModifier.CODEC);
