...
public class FoodList {
    ...
    public static final FoodProperties PORK_CARROT_WONTON = new FoodProperties.Builder().nutrition(17).saturationModifier(0.5F).effect(() -> comfort(LONG_DURATION), 1.0F).build();
    public static final FoodProperties PORK_MUSHROOM_WONTON = new FoodProperties.Builder().nutrition(16).saturationModifier(0.6F).effect(() -> comfort(LONG_DURATION), 1.0F).build();
    public static final FoodProperties PORK_CABBAGE_WONTON = new FoodProperties.Builder().nutrition(12).saturationModifier(0.8F).effect(() -> comfort(LONG_DURATION), 1.0F).build();
    ...
    public static final FoodProperties RABBIT_MEAT_BOILED_DUMPLING = new FoodProperties.Builder().nutrition(5).saturationModifier(0.7F).effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 15*20, 0), 1.0F).build();
    ...
    public static final FoodProperties GARLIC_CLOVE = new FoodProperties.Builder().nutrition(0).saturationModifier(0).effect(() -> new MobEffectInstance(EffectRegistry.GARLIC, 18*20, 0), 1).alwaysEdible().build();
    ...
    public static final FoodProperties GARLIC = new FoodProperties.Builder().nutrition(1).saturationModifier(0.2F).effect(() -> new MobEffectInstance(EffectRegistry.GARLIC, 75*20, 0), 1).alwaysEdible().build();
    public static final FoodProperties GREEN_ONION = new FoodProperties.Builder().nutrition(1).saturationModifier(0.2F).build();
